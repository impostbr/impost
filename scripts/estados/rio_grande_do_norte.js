/**
 * ═══════════════════════════════════════════════════════════════════════════
 * RIO_GRANDE_DO_NORTE.JS — Base de Dados Tributária Completa do Estado do Rio Grande do Norte
 * ═══════════════════════════════════════════════════════════════════════════
 * Versão 3.0 — Padronizado conforme modelo roraima.js v3.0
 * Dados verificados via fontes oficiais (SEFAZ/RN, RFB, Planalto, Prefeitura de Natal/SEMUT)
 * ═══════════════════════════════════════════════════════════════════════════
 *
 ...
 *   • Lei nº 6.968/1996 (ICMS/RN)
 *   • Lei nº 11.314/2022 (ICMS 18%)
 *   • Lei nº 11.999/2024 (ICMS 20%)
 *   • Decreto nº 31.825/2022 (RICMS/RN)
 *   • Lei nº 6.967/1996 (IPVA/RN)
 *   • Lei nº 9.689/2013 (IPVA alterações)
 *   • Lei nº 12.026/2024 (IPVA elétrico)
 *   • Lei nº 3.882/1989 (CTM Natal)
 *   • LC nº 217/2022, LC nº 197/2021 (ISS Natal)
 *   • LC nº 254/2024, LC nº 257/2024, LC nº 265/2025, Decreto nº 13.573/2025 (IPTU Natal)
...
const RIO_GRANDE_DO_NORTE_TRIBUTARIO = {
    ...
    // ═══════════════════════════════════════════════════════════════
    //  5. ISS — IMPOSTO SOBRE SERVIÇOS (Natal — referência)
    // ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
//  14. FUNÇÕES UTILITÁRIAS — RIO GRANDE DO NORTE
// ═══════════════════════════════════════════════════════════════════════════
 ...
 * @returns {object}
 */
function getISSRioGrandeDoNorte(tipo) {
    const aliases = {
        saude: "medicina",
    ...
    const servico = RIO_GRANDE_DO_NORTE_TRIBUTARIO.iss.por_tipo_servico[tipoNormalizado];
 ...
 * @returns {object}
 */
function getIPTUResidencialRioGrandeDoNorte(areaM2) {
    return {
        aliquota: RIO_GRANDE_DO_NORTE_TRIBUTARIO.iptu.residencial.aliquota,
        percentual: RIO_GRANDE_DO_NORTE_TRIBUTARIO.iptu.residencial.percentual,
 ...
 * @returns {object}
 */
function getIPTUComercialRioGrandeDoNorte(areaM2) {
    return {
        aliquota: RIO_GRANDE_DO_NORTE_TRIBUTARIO.iptu.comercial.aliquota,
        percentual: RIO_GRANDE_DO_NORTE_TRIBUTARIO.iptu.comercial.percentual,
        tipo: "Alíquota única (sem progressão por área)"
    };
}
 ...
 * @returns {object}
 */
function getIPVARioGrandeDoNorte(tipo) {
    const veiculo = RIO_GRANDE_DO_NORTE_TRIBUTARIO.ipva.aliquotas[tipo];
    if (veiculo) {
        return veiculo;
    }
    return {
 ...
 * @returns {boolean}
 */
function isZonaFrancaRioGrandeDoNorte(municipio) {
    return false;
}
 ...
 * @returns {boolean}
 */
function isALCRioGrandeDoNorte(municipio) {
    return false;
}
 ...
 * @returns {object}
 */
function getReducaoSUDENERioGrandeDoNorte() {
    return {
        ativo: true,
        reducao: 0.75,
 ...
 * @returns {object}
 */
function getReducaoSUDAMRioGrandeDoNorte() {
    return {
        ativo: false,
        observacao: "Rio Grande do Norte NÃO está na área de abrangência da SUDAM",
        reducao: 0,
 ...
 * @returns {object}
 */
function getICMSEfetivoRioGrandeDoNorte() {
    const icms = RIO_GRANDE_DO_NORTE_TRIBUTARIO.icms;
 ...
 * @returns {object|null}
 */
function getAliquotaModalRioGrandeDoNorte(produto) {
    const modal = RIO_GRANDE_DO_NORTE_TRIBUTARIO.icms.aliquotas_modais[produto];
    if (modal) {
        return modal;
    }
    return null;
 ...
 * @returns {object}
 */
function resumoTributarioRioGrandeDoNorte() {
    const d = RIO_GRANDE_DO_NORTE_TRIBUTARIO;
    return {
        ...
        icms_efetivo: getICMSEfetivoRioGrandeDoNorte().aliquota_efetiva,
...
if (typeof module !== "undefined" && module.exports) {
    module.exports = {
        ...RIO_GRANDE_DO_NORTE_TRIBUTARIO,
        utils: {
            getISS: getISSRioGrandeDoNorte,
            getIPTUResidencial: getIPTUResidencialRioGrandeDoNorte,
            getIPTUComercial: getIPTUComercialRioGrandeDoNorte,
            getIPVA: getIPVARioGrandeDoNorte,
            isZonaFranca: isZonaFrancaRioGrandeDoNorte,
            isALC: isALCRioGrandeDoNorte,
            getReducaoSUDENE: getReducaoSUDENERioGrandeDoNorte,
            getReducaoSUDAM: getReducaoSUDAMRioGrandeDoNorte,
            getICMSEfetivo: getICMSEfetivoRioGrandeDoNorte,
            getAliquotaModal: getAliquotaModalRioGrandeDoNorte,
            resumoTributario: resumoTributarioRioGrandeDoNorte,
        },
    };
}

if (typeof window !== "undefined") {
    window.RIO_GRANDE_DO_NORTE_TRIBUTARIO = RIO_GRANDE_DO_NORTE_TRIBUTARIO;
    window.RioGrandeDoNorteTributario = {
        getISS: getISSRioGrandeDoNorte,
        getIPTUResidencial: getIPTUResidencialRioGrandeDoNorte,
        getIPTUComercial: getIPTUComercialRioGrandeDoNorte,
        getIPVA: getIPVARioGrandeDoNorte,
